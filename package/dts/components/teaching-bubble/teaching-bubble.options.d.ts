 ...
 */
export declare const TeachingBubbleSize: {
 ...
 */
export declare type TeachingBubbleSize = ValuesOf<typeof TeachingBubbleSize>;
export declare const TeachingBubblePlacement: {
    readonly top: "top";
...
export declare type TeachingBubblePlacement = ValuesOf<typeof TeachingBubblePlacement>;
